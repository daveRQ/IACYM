...
{
    public partial class MemberShowProTempleOfferingAll : Form
    {
        private int Code;
        public MemberShowProTempleOfferingAll(int codigo)
        {
            InitializeComponent();
            this.Code = codigo;
        ...
        {
            SqlConnection connection = new SqlConnection(General_Values.str_connection);
            string str_consult = "SELECT * FROM ofrenda_pro_templo WHERE cod_miembro = " + this.Code + ";";
        ...
        private void ButtonBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (TextBoxBuscarMes.Text != "Ingrese Mes" && TextBoxBuscarAño.Text == "Ingrese Año")
            {
                ...
                if (check)
                {
                    SqlConnection connection = new SqlConnection(General_Values.str_connection);
                    connection.Open();
                    string str_consult = "SELECT * FROM ofrenda_pro_templo WHERE mes = '" + mes + "' AND cod_miembro = " + this.Code + ";";
                    SqlCommand consult = new SqlCommand(str_consult, connection);
                    SqlDataReader record = consult.ExecuteReader();
            ...
            else if (TextBoxBuscarMes.Text == "Ingrese Mes" && TextBoxBuscarAño.Text != "Ingrese Año")
            {
                ...
                if (check)
                {
                    SqlConnection connection = new SqlConnection(General_Values.str_connection);
                    connection.Open();
                    string str_consult = "SELECT * FROM ofrenda_pro_templo WHERE año = '" + año + "' AND cod_miembro = " + this.Code + ";";
        ...
        private void ButtonEliminar_Click(object sender, EventArgs e)
        {
            ...
            else if (!Id.ExistsId("ofrenda_pro_templo", "id", id))
                check = false;

            if (check)
            {
                Id.DeleteId("ofrenda_pro_templo", "id", int.Parse(id));
